...
client.on('message', message => {
  ...
  client.channels.get("445999988376338432").send(
      "\n" + "**" + " ● المقترح : " + "**" +
      "\n" + "**" + "» " + message.author.tag + "**" +
      "\n" + "**" + " ● الاقتراح : " + "**" +
      "\n" + "**" + args + "**")
...
client.on("message", message => {
 ...
 if (message.content === "^^help") {
  ...
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .addField("『ZOMBIE CLAN』 『اسم البوت』", true)
      
      .addField("『@ĦÂмØ♚#6947 مصمم البوت』", true)
...
القسم الثالث مصمم البوت | @ĦÂмØ♚⁺¹⁸#6947
رابط البوت 
● ▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬ ● 
...
if (message.content === '^^invite') {
      message.author.send(' رابط البوت | https://discordapp.com/api/oauth2/authorize?client_id=444275191628169216&permissions=0&scope=bot ').catch(e => console.log(e.stack));
...
client.on('message', message=>{
 ...
 if (message.content.startsWith("منور")) {
  ...
  .addField("***نورت يا عسل***" ,mentionavatar.username )
...
msg.reply(`ۆعـلُـيَـگـم آلُـسـلُآم ۆرحٍـمةّ آلُلُہ ۆبْرگآتٌہ ، منْۆر. :rose::sparkles:`)
}
});
...
msg.reply(`ﯣڵــڶــڬــمۭ نۨــۏڕٺ ۛ ּيۧ مۭــڗ ۛ ּ، ۛ :rose::rose:`)
}
});
